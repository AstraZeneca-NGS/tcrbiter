...
# v0.0.2 adapted to Python 3 and Pandas 1.0 by Benjamin Ostendorf (5/19/2020)
...
#parser.add_argument('--outdir', help='Output directory, defaults to pwd', required=False)
...
# if args.outdir:
#     outdir = args.outdir
tcr_outdir = os.path.join(outdir, "TCRbiter_out", readpairkey, "tcrOutput")
tcr_errordir = os.path.join(outdir, "TCRbiter_out", readpairkey, "tcrError")
...
if child.returncode:
    ...
    sys.exit(1)
with open(os.path.join(tcr_errordir, "MixcrAlign.error.txt"), "wb") as oh:
    oh.write(perr)
with open(os.path.join(tcr_errordir, "MixcrAlign.stdout.txt"), "wb") as oh:
    oh.write(pout)
...
if child.returncode:
    logger.error("Error running %s." % cline)
    sys.exit(1)
with open(os.path.join(tcr_errordir, "MixcrExport.error.txt"), "wb") as oh:
    oh.write(perr)
with open(os.path.join(tcr_errordir, "MixcrExport.stdout.txt"), "wb") as oh:
    oh.write(pout)
...
if child.returncode:
    logger.error("Error running %s." % cline)
    sys.exit(1)
with open(os.path.join(tcr_errordir, "blastread1.error.txt"), "wb") as oh:
    oh.write(perr)
with open(os.path.join(tcr_errordir, "blastread1.stdout.txt"), "wb") as oh:
    oh.write(pout)
...
if child.returncode:
    logger.error("Error running %s." % cline)
    sys.exit(1)
with open(os.path.join(tcr_errordir, "blastread2.error.txt"), "wb") as oh:
    oh.write(perr)
with open(os.path.join(tcr_errordir, "blastread2.stdout.txt"), "wb") as oh:
    oh.write(pout)
...
if child.returncode:
    logger.error("Error running %s." % cline)
    sys.exit(1)
with open(os.path.join(tcr_errordir, "blastcleanread1.error.txt"), "wb") as oh:
    oh.write(perr)
with open(os.path.join(tcr_errordir, "blastcleanread1.stdout.txt"), "wb") as oh:
    oh.write(pout)
...
if child.returncode:
    logger.error("Error running %s." % cline)
    sys.exit(1)
with open(os.path.join(tcr_errordir, "blastcleanread2.error.txt"), "wb") as oh:
    oh.write(perr)
with open(os.path.join(tcr_errordir, "blastcleanread2.stdout.txt"), "wb") as oh:
    oh.write(pout)
...
if child.returncode:
    logger.error("Error running %s." % cline)
    sys.exit(1)
with open(os.path.join(tcr_errordir, "bedtoolsintersect.read1.error.txt"), "wb") as oh:
    oh.write(perr)
with open(os.path.join(tcr_errordir, "bedtoolsintersect.read1.stdout.txt"), "wb") as oh:
    oh.write(pout)
read2bed = os.path.join(tcr_outdir, readpairkey + ".read2.bed")
...
if child.returncode:
    logger.error("Error running %s." % cline)
    sys.exit(1)
with open(os.path.join(tcr_errordir, "bedtoolsintersect.read2.error.txt"), "wb") as oh:
    oh.write(perr)
with open(os.path.join(tcr_errordir, "bedtoolsintersect.read2.stdout.txt"), "wb") as oh:
    oh.write(pout)
...
sseqid_per_read1 = sseqid_per_read1.rename_axis(None)
...
sseqid_per_read2 = sseqid_per_read2.rename_axis(None)
...
with open(blastdb + ".fai") as ih:
    ...
    chromsizes = list(map(int, [x.split()[1].strip() for x in chromlines if x.isdigit()]))
